...
# setwd("/path/to/csmGmm_reproduce//Fig4B") or set the path after the -cwd flag
...
if (doQCH) {
  ...
  H1config_qch <- qch::GetH1AtLeast(Hconfig_qch, AtLeast = 3)
  qch_test_name <- paste0("AtLeast_", 3)
}
